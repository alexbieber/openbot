...
// Serve index.html at / (must be before /:file so "/" is not matched as file "")
router.get('/', (req, res) => {
...
router.get('/:file', (req, res, next) => {
  ...
  // Block path traversal and empty segment
  if (!file || file.includes('..') || file.includes('/')) return next();
